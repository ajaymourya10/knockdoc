...
public class RequestPrescription extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ProgressBar progressBar, drProgressBar;
    private Context context;
    private RequestPrescriptionAdapter imageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Request for Prescription");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if(snapshot.child("status").getValue().toString().equals("approved")) {
                        ...
                        pendingAppointment.setPatient_mob(_mobileNo);
                ...
                imageAdapter = new RequestPrescriptionAdapter(getApplicationContext(), mPendingAppointments);
