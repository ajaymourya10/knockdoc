...
public class PendingAppointmentPatient extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ProgressBar progressBar, drProgressBar;
    private Context context;
    private PatientAppointmentAdapter imageAdapter;
    ...
    private void GetDataFromFirebase() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                imageAdapter = new PatientAppointmentAdapter(getApplicationContext(), mPendingAppointments);
