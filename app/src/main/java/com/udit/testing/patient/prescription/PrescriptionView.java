...
public class PrescriptionView extends AppCompatActivity {
    ...
    private PrescriptionViewAdapter imageAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Prescribed Patients");
    ...
    private void GetDataFromFirebase() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                imageAdapter = new PrescriptionViewAdapter(getApplicationContext(), mPendingAppointments);
