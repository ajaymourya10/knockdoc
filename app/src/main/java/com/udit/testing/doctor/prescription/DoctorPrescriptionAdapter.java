...
public class DoctorPrescriptionAdapter extends RecyclerView.Adapter<DoctorPrescriptionAdapter.ImageViewHolder> {
    private Context context;
    private ArrayList<AppointmentDoctor> mPendingAppointment;

    private ArrayList<AppointmentDoctor> mPendingAppointmentFull;

    public DoctorPrescriptionAdapter(Context context, ArrayList<AppointmentDoctor> mPendingAppointment) {
    ...
    public void onBindViewHolder(@NonNull ImageViewHolder holder, int position) {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference()
                ...
                .child(appointmentCurrent.getPatient_mobile()).child(appointmentCurrent.getCount());
